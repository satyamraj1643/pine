  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      if (typeof result === "string" || result instanceof Error) {
        ...
        const errorMessage = typeof result === "string" ? result : result.message || "Failed to create collection.";
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              >
                Create a new tag collection to organize your entries
              </p>
            </div>
          </div>
        </div>
